...
<Columns cols={2}>
  ...
  <Card title="Authentication" icon="lock" iconType="sharp-solid" href="/server/authentication">
  ...
  <Card title="AI-enhanced passes" icon="sparkles" iconType="sharp-solid" href="/generation/ai-passes">
