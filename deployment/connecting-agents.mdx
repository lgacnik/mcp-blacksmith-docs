...
<Frame>
  <img src="/images/security-architecture.png" alt="MCP client connected to multiple MCP servers — each protecting a different API with its own authentication and security layer" />
</Frame>
