...
- **Enhancer** — rewrites operation and parameter names and descriptions for better AI agent discoverability and usability, and resolves duplicate operation names
