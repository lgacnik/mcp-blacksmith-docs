...
<Note>
This pass only enhances names and descriptions. It does not modify parameter types, constraints, or any other validation properties defined in the specification.
</Note>
