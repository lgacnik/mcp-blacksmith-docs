...
<AccordionGroup>
  ...
  <Accordion title="Where can I host the generated servers?">
    Anywhere you can run Python 3.11+. Self-host on your infrastructure, deploy to any cloud, run in Docker, or use [MCP Armory](https://mcparmory.com) for managed hosting.
  </Accordion>
