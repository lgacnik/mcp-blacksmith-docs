...
<AccordionGroup>
  ...
  <Accordion title="Which MCP clients are supported?">
    Any MCP-compatible client, including Claude Desktop, Claude Code, Cursor, and other tools that implement the Model Context Protocol. Generated servers support stdio, SSE, and streamable-http transports.
  </Accordion>
</AccordionGroup>
